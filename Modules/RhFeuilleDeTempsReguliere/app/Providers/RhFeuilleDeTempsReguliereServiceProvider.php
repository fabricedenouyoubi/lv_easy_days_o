...
namespace Modules\RhFeuilleDeTempsReguliere\Providers;
...
class RhFeuilleDeTempsReguliereServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'RhFeuilleDeTempsReguliere';

    protected string $nameLower = 'rhfeuilledetempsreguliere';
