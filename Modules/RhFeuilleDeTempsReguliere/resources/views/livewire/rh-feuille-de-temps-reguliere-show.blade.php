<div>
    ...
    @if($this->operation && $this->employe)
        <!-- Main content area -->
        <div class="row">
    ...
    @else
        ...
        <div class="card shadow-sm">
            <div class="card-body text-center py-5">
                ...
                <h4 class="mt-3 text-danger">Erreur de chargement</h4>
                <p class="text-muted">Impossible de charger les données de la feuille de temps.</p>
