...
namespace Modules\RhEmploye\Tests\Feature;
...
use Modules\RhEmploye\Livewire\EmployeDetails;
use Modules\RhEmploye\Livewire\EmployeEditForm;
use Modules\RhEmploye\Livewire\EmployeForm;
use Modules\RhEmploye\Livewire\HistoriqueGestionnaireForm;
use Modules\RhEmploye\Models\Employe;
use Tests\TestCase;

class EmployeFeatureTest extends TestCase
{
    ...
    public function test_can_update_employe_details()
    {
        ...
        $this->seeder(GroupSeeder::class);
        $group = Group::first();


        Livewire::test(EmployeEditForm::class, ['employeId' => $employe->id])
            ->set('nom', 'Nouveau')
            ->set('prenom', 'Prenom')
    ...
    {
        $employeId = $this->insert_employe();
        Livewire::test(EmployeEditForm::class, ['employeId' => $employeId])
            ->set('nom', '')
            ->set('prenom', '')
            ->set('email', '')
            ->call('save')
...
/*
    - commnande de test
    - php artisan test Modules/RhEmploye/Tests/Feature/EmployeFeatureTest.php
 */
