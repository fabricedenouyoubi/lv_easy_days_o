    ...
    <div class="row g-4">
        ...
        <div class="col-12">
            <div class="user-sidebar">
                ...
                <div class="row w-100">
                    <div class="card shadow-sm rounded-3 border-0 col-12 col-md-3">
                        ...
                        <div class="card-body p-0">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                <a class="nav-link border-0 rounded-0 py-3 px-4 d-flex align-items-center information active"
                                ...
                                <a class="nav-link border-0 rounded-0 py-3 px-4 d-flex align-items-center"
                                    ...
                                    role="tab" aria-controls="v-pills-password" aria-selected="false" wire:click='toogle_pwd' wire:ignore >
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="info-item">
                                                ...
                                                <p class="mb-0 fs-6">{{ $employe->gestionnaire?->nom ?? '---' }}</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="info-item">
                        ...
                        <div id="historiqueGestionnaire-table">
                            <div class="card-header bg-transparent border-0 py-3">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <a
                                        class="btn btn-sm btn-outline-primary btn-sm rounded-3 px-3 d-flex align-items-center">
