    ...
    <form wire:submit.prevent="save">
        ...
        <div class="alert alert-info mb-4">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h6 class="mb-1">Modification du quota de {{ $configuration?->employe?->nom }}
                        {{ $configuration?->employe?->prenom }}</h6>
                ...
                <div class="col-md-12">
                    <div class="alert alert-light">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h6 class="mb-1">{{ $configuration->employe->nom }}
                                    {{ $configuration->employe->prenom }}</h6>
                                @if ($configuration->employe->matricule)
                                    <small class="text-muted">Matricule :
                                        {{ $configuration->employe->matricule }}</small>
                                @endif
                            </div>
                        </div>
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input type="number" id="quota" class="form-control @error('quota') is-invalid @enderror"
                            wire:model="quota" step="0.01" min="0" max="9999.99" placeholder="Ex: 24.00">
