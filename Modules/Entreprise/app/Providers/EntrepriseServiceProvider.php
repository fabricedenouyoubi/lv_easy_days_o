...
use Modules\Entreprise\Livewire\EntrepriseInfo;
use Modules\Entreprise\Livewire\SiteForm;
use Modules\Entreprise\Livewire\SitesList;
...
class EntrepriseServiceProvider extends ServiceProvider
{
    ...
    protected string $name = 'Entreprise';

    protected string $nameLower = 'entreprise';
