...
namespace Modules\RhFeuilleDeTempsAbsence\Providers;
...
class RhFeuilleDeTempsAbsenceServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'RhFeuilleDeTempsAbsence';

    protected string $nameLower = 'rhfeuilledetempsabsence';
