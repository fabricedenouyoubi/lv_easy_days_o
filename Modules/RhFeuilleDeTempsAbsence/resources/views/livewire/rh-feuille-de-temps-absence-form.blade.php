<form wire:submit.prevent="save">
    <h6 class="text-muted small text-uppercase mb-2"><i class="fas fa-calendar-alt me-1"></i>Informations de la demande
        d'absence</h6>
    <div class="mb-3">
    ...
    <div class="modal-footer">
        <x-action-button type="secondary" icon="fas fa-times me-2" size="md" wireClick="{{ $demande_absence_id ? 'resetAll' : 'cancel' }}" text="Annuler" />
        <x-action-button type="success" icon="fas fa-save me-2" size="md" text="{{ $demande_absence_id ? 'Modifier' : 'Enregistrer' }}" typeButton='submit' />
    </div>
</form>
