<div>
    ...
    <form wire:submit.prevent="save">
        ...
        <div class="mb-3" id="div_id_email">
            ...
            <input type="email" wire:model.defer="email" id="id_email" maxlength="200"
                placeholder="employe@exemple.com" class="form-control  emailinput @error('email') is-invalid @enderror">
        ...
        <div class="modal-footer">
            <x-action-button type="secondary" icon="fas fa-times me-2" size="md" wireClick='cancel'
                text="Annuler" />
            <x-action-button type="success" icon="fas fa-save me-2" size="md" text="Modifier"
                typeButton='submit' />
        </div>
    </form>
</div>
