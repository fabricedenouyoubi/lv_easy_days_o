    ...
    public function resetPassword(): void
    {
        ...
        if ($status != Password::PASSWORD_RESET) {
            if ($status == 'passwords.token') {
                $this->addError('error', __('Le jeton de réinitialisation de mot de passe n\'est pas valide.'));
                return;
            } elseif ($status == 'passwords.user') {
                $this->addError('error', __('Nous ne trouvons pas d\'utilisateur avec cette adresse e-mail.'));
                return;
            } else {
                                        ...
                                        <div class="w-100">
                                            <div class="d-flex flex-column h-100">
                                                <div class="mb-4 mb-md-3">
                                                    <a href="route('password.reset')" class="d-block auth-logo">
                                                ...
                                                <div class="auth-content my-auto">
                                                    <div class="text-center">
                                                        ...
                                                        <p class="text-muted mt-2">Veillez entrer votre nouveau mot de passe
                                                        </p>
                                                    </div>
                                                    ...
                                                    <form class="mt-4 pt-2" wire:submit.prevent="resetPassword">
                                                        ...
                                                        <div id="div_id_password" class="mb-4"> <label
                                                                for="id_password" class="form-label requiredField">
                                                                Confirmation mot de passe<span
                                                                    class="asteriskField text-danger">*</span>
