        ...
        try {
            ...
            if ($status != Password::RESET_LINK_SENT) {
                if ($status == 'passwords.throttled') {
                    $this->addError('error', __('Veuillez patienter avant de réessayer.'));
                ...
                $this->addError('success', __('Veuillez consulter votre boîte mail.'));
            }
                                                ...
                                                <div class="d-flex flex-column h-100">
                                                    ...
                                                    <div class="auth-content my-auto">
                                                        <div class="text-center">
                                                            ...
                                                            <p class="text-muted mt-2">Entrez votre e-mail et des
                                                                instructions vous seront envoyées pour la réinitialisation
                                                        ...
                                                        <form class="mt-4 pt-2"
                                                            ...
                                                            <div id="div_id_login" class="mb-4"> <label for="id_login"
